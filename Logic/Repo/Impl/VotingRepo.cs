...
{
    internal class VotingRepo : BaseRepo<Voting>, IVotingRepo
    {
        public VotingRepo(ISession session)
            : base(session)
        { }
        ...
        public List<VotingDM> GetActualVoting(Int32 charterID)
        {
            ...
            var parm = new OracleParameter("@charterID", OracleDbType.Varchar2);
            parm.Direction = ParameterDirection.Input;
            parm.Value = charterID;
            command.Parameters.Add(parm);

            //command.Parameters.Add("charterID", OracleDbType.Int32).Value = charterID;
