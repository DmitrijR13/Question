...
(function ($) {
    ...
    EditableSelect.prototype = {
        ...
        init: function (select, settings) {
            ...
            this.setWidths();
            this.current_value = settings.current_value;
            this.text.val(settings.current_value);
        ...
        */
        duplicateOptions: function () {
            ...
            options.each(function () {
                ...
                var li = $('<li val="' + $(this).val() + '">' + $(this).text() + '</li>');
        ...
        */
        ...
        function (e) {
            switch (e.keyCode) {
                ...
                // Tab    
                case 9:
                    context.pickListItemTab(context.selectedListItem());
                    break;
                // Esc    
                case 27:
                    e.preventDefault();
        ...
        */
        ...
        pickListItemTab: function (list_item) {
            if (list_item.length) {
                this.current_value = this.text.val();
            };
            if (typeof this.settings.onSelect == 'function') {
