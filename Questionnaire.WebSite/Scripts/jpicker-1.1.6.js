...
(function($, version)
{
      ...
      return this.each(
        function()
        {
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            documentMouseMove =
              function(e) {
                  //  { left: $("#tools_drag").offset().left + 50 + 'px', top: $("#tools_drag").offset().left + 50 + 'px' }
            ...
            show =
              function()
              {
                ...
                if (settings.window.expandable)
                {
                  ...
                  container.css({ left: $("#tools_drag").offset().left + 200 + 'px', top: $("#tools_drag").offset().top + 80 + 'px', zIndex:20});
                }
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: fullpath + 'Content/themes/jPicker/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
