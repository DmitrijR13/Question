...
using Sobits.Story.Logic.Extensions;
using System.Xml;
using NHibernate;
...
{
    internal class VotingQuestionRepo : AbstractRepo<VotingQuestion>, IVotingQuestionRepo
    {
        public VotingQuestionRepo(DataEngine.IDataSession session)
            : base(session)
        { }
